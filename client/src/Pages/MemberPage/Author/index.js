            ...
            <div className="white-block">
              <div className="my-sidebar">
                <div className="my-avatar">
                  <img
                    src="https://nhatbanonline.net/wp-content/uploads/2020/02/co-4-la-may-man-3.jpg"
                    width="150"
                    height="150"
                    alt="Avatar"
                    className="avatar"
            ...
            <div className="col-sm-9">
              ...
              <div id="accordionExample" className="right-part">
                <Card>
                  ...
                  >
                    <Card.Body>To la ha beo, an nhieu nhat day</Card.Body>
                  </Collapse>
                </Card>
                                        ...
                                        <th>
                                          <a href="/">
                                            <div className="th-inner-route">
                                              <img
                                                src="https://img-global.cpcdn.com/recipes/3c872698969f85ec/400x400cq70/photo.jpg"
                                                alt="banh cuon"
                                                width="120"
                                                height="80"
                                              ></img>
